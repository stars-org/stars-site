...
// 背景图片 Cookies 
const defaultPictures = Array.from({ length: 10 }, (_, index) => `./assets/images/backgrounds/background${index + 1}.webp`);
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            $('#bg').attr('src', defaultPictures[Math.floor(Math.random() * defaultPictures.length)])
            break;
        case "2":
